...
-- Upgrade: widen SURFACE for MODEL: prefix requests (was VARCHAR(20), now VARCHAR(100))
ALTER TABLE IF EXISTS CC_CREDIT_REQUESTS MODIFY COLUMN SURFACE VARCHAR(100);
